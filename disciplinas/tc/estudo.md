...
- **Avaliação Bimestral AV1:** esta semana é dedicada à realização da 1ª
  ...
  aula, leituras obrigatórias indicadas no livro de referência, e todo o
  material dos seminários (artigos e/ou slides). Observações:
...
- **Leituras obrigatórias:**
  - Livro texto: prefácios da 1ª, 2ª e 3ª edições (páginas *xi* até *xxii*)
- **Outras atividades:**
  - Divisão de grupos e criação do calendário de apresentação dos
    seminários sobre computação, programação e teoria da computação.
